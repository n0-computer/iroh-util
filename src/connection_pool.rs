...
impl ConnectionPool {
    ...
    ///
    /// This returns after approximately [`Options::connect_timeout`] with either
    /// an error or a connection, plus the time [`Options::on_connected`] takes
    /// and the time the request waits in the pool's inbox.
